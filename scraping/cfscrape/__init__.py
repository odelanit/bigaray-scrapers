...
class CloudflareScraper(Session):
    ...
    def cloudflare_is_bypassed(self, url, resp=None):
        ...
        return (
            self.cookies.get("__cf_bm", None, domain=cookie_domain) or
            (resp and resp.cookies.get("__cf_bm", None, domain=cookie_domain))
        )
        ...
        return (
            {
                ...
                "__cf_bm": scraper.cookies.get(
                    "__cf_bm", "", domain=cookie_domain
                ),
            },
